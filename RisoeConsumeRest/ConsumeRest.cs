...
namespace RisoeConsumeRest
{
    class ConsumeRest
    {
        ...
        public void Test()
        {
            ...
            Console.WriteLine("");
            Opgave testOpgave10 = new Opgave(10, "En test Opagve", Opgave.StatusType.IkkeLøst, 2);
            ...
            testOpgave10 = new Opgave(10, "Test af Opdatering", Opgave.StatusType.Løst, 5);
            ...
            using (HttpClient client = new HttpClient())
            {
                ...
                if (resultMessage.IsSuccessStatusCode)
                {
                    ...
                    if (opgave == null)
                    {
                        Console.WriteLine("Succes, opgave 10 er slettet");
                    }
                    else
                    {
                        Console.WriteLine("fejl, opgave 10 eksistere stadig:");
